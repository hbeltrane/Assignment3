	...
	<main class="container">
	    ...
	    <div class="card" style="width: 18rem;">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><b>Qualification: </b> ${student.qualification}</li>
            <li class="list-group-item"><b>Percentage: </b> ${student.percentage}</li>
            <li class="list-group-item"><b>Year Passed: </b> ${student.yearPassed}</li>
          </ul>
        </div>
